...
const ManageBookLending = (props) => {
    ...
    const listBookLendingFilter = bookLends.filter(e => e.book_id.toLowerCase().includes(searchKeywordLowerCase));

    console.log('selectedLendingBook  ', selectedLendingBook);
